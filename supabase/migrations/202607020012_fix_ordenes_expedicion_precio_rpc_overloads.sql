-- Limpieza de overloads viejos para evitar que PostgREST resuelva firmas obsoletas
-- y redefinición de las RPC canónicas con total_venta explícito.

drop function if exists public.registrar_orden_expedicion(uuid, uuid, text, numeric, numeric, text, text, text);
drop function if exists public.registrar_orden_expedicion(uuid, uuid, text, numeric, numeric, text, text, uuid, text, numeric, numeric, numeric, text, text);
drop function if exists public.registrar_orden_expedicion(uuid, uuid, numeric, text, text, numeric, text, text, uuid, text, numeric, numeric, numeric, text, text);
drop function if exists public.registrar_orden_expedicion(uuid, uuid, numeric, text, text, numeric, text, text, uuid, text, numeric, numeric, numeric, text, text, numeric, text);

drop function if exists public.actualizar_orden_expedicion(uuid, text, numeric, numeric, text, text, text);
drop function if exists public.actualizar_orden_expedicion(uuid, text, numeric, numeric, text, text, uuid, text, numeric, numeric, numeric, text, text);
drop function if exists public.actualizar_orden_expedicion(uuid, text, text, numeric, numeric, text, text, uuid, text, numeric, numeric, numeric, text, text);
drop function if exists public.actualizar_orden_expedicion(uuid, text, text, numeric, numeric, text, text, uuid, text, numeric, numeric, numeric, text, text, numeric, text);

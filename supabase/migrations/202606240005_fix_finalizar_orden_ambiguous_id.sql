...
begin
  ...
  loop
    ...
    where i.legacy_uid = v_item.id_insumo_legacy
    ...
    loop
      ...
      set cantidad_comprometida = greatest(0, coalesce(sl_upd.cantidad_comprometida, 0) - v_consumido_lote)

alter table public.tesoreria_cheques
  drop constraint if exists tesoreria_cheques_estado_chk;

alter table public.tesoreria_cheques
  add constraint tesoreria_cheques_estado_chk
  check (estado in ('PENDIENTE', 'A_DEPOSITAR', 'DEPOSITADO', 'COBRADO', 'RECHAZADO', 'ENDOSADO', 'VENCIDO'));

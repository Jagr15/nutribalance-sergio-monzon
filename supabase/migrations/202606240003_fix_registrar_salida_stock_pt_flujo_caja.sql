-- Evita que la expedición falle cuando el flujo de caja no tenga un monto financiero positivo.
-- La salida de PT y la trazabilidad deben registrarse siempre.
-- El movimiento financiero solo se crea si el monto calculado es mayor a cero.
